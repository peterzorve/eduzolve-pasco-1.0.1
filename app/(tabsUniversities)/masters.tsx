...
export default function MastersDegree() {
  ...
  const bachelorsPrograms = degreePrograms.filter( (university) => (university.name === universityInfo?.name) &&  (university.category === "masters") );
    ...
    <View style={{ flex: 1 }}>
      <ScrollView style={{  width: "100%", alignSelf: "center", marginTop: 50 }} showsVerticalScrollIndicator={false}> 
          ...
          <View style={{ width: "90%", alignSelf: "center",  }} >
            <TitleAndDescription title={ "Masters programs"} titleFontSize={26} titleColor={colorScheme === "dark" ? "white" : "black"} />
