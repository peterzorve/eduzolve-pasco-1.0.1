    ...
    <View style={{ flex: 1,    alignSelf: "center",     width: "100%",  }}>
      <ScrollView showsVerticalScrollIndicator={false} style={{}} >
        ...
        <View style={{alignSelf: "center",  width: "90%", borderRadius: 10, marginVertical: 10}} > 
          ...
          {/* <PackagesInformations offering="Ace Your WAEC Exams: Practice Anytime, Anywhere"      description="You are ble to ace your examinations with ease with EduZolve Pasco" delay={50} duration={3000}/> */}
          ...
          <PackagesInformations delay={220} duration={2200} onPress={makePaymentCustomize} access={true} offering="Prepare for WAEC with Smart Practice"                 description="Study smart, not neccessarily hard. EduZolve Pasco makes you achieve that" />
